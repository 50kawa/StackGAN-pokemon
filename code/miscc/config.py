...
__C.CONFIG_NAME = ''
__C.DATA_DIR = ''
__C.AUTO_ENCODER_MODEL_DIR = 'auto-encoder-pokemon/autoencoder_best.pth'
...
__C.TRAIN.LOSS_GRAD = edict()
__C.TRAIN.LOSS_GRAD.POKEMON_CHAR = 1.0
__C.TRAIN.LOSS_GRAD.POKEMON_TYPE = 1.0
__C.TRAIN.LOSS_GRAD.POKEMON_HABCDS = 1.0
