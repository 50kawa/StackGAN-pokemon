...
if __name__ == "__main__":
    ...
    cfg.TRAIN.NET_G = '../output/pokemon_3stages_2020_06_20_10_59_38/Model/netG_110000.pth'
    while True:
        ...
        while True:
            ...
            # habcds = input().split(',')
            habcds = "55,60,130,30,130,5".split(',')
            if len(habcds)!=6:
        ...
        algo.generate_one_img([char_input], char_list, type)
        break
